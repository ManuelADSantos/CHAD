...
set_module_property NAME GreyScale_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME GreyScale_system
...
### SLAVE interface avs_GreyScale_cra
add_interface avs_GreyScale_cra avalon end
set_interface_property avs_GreyScale_cra addressAlignment DYNAMIC
set_interface_property avs_GreyScale_cra burstOnBurstBoundariesOnly false
set_interface_property avs_GreyScale_cra explicitAddressSpan 0
set_interface_property avs_GreyScale_cra holdTime 0
set_interface_property avs_GreyScale_cra isMemoryDevice false
set_interface_property avs_GreyScale_cra isNonVolatileStorage false
set_interface_property avs_GreyScale_cra linewrapBursts false
set_interface_property avs_GreyScale_cra maximumPendingReadTransactions 1
set_interface_property avs_GreyScale_cra printableDevice false
set_interface_property avs_GreyScale_cra readLatency 0
set_interface_property avs_GreyScale_cra readWaitTime 0
set_interface_property avs_GreyScale_cra setupTime 0
set_interface_property avs_GreyScale_cra timingUnits Cycles
set_interface_property avs_GreyScale_cra writeWaitTime 0
set_interface_property avs_GreyScale_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_GreyScale_cra ENABLED true
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_read read Input 1
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_write write Input 1
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_address address Input 4
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_writedata writedata Input 64
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_byteenable byteenable Input 8
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_readdata readdata Output 64
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_readdata readdata Output 64
add_interface_port avs_GreyScale_cra avs_GreyScale_cra_readdatavalid readdatavalid Output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL GreyScale_system
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file GreyScale.v SYSTEM_VERILOG PATH GreyScale.v TOP_LEVEL_FILE
add_fileset_file GreyScale_system.v SYSTEM_VERILOG PATH GreyScale_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL GreyScale_system
add_fileset_file GreyScale.v SYSTEM_VERILOG PATH GreyScale.v TOP_LEVEL_FILE
add_fileset_file GreyScale_system.v SYSTEM_VERILOG PATH GreyScale_system.v TOP_LEVEL_FILE
add_fileset_file acl_data_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_data_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_debug_mem.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_debug_mem.v TOP_LEVEL_FILE
