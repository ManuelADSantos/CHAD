...
set_interface_property avs_vectorAdd_cra readWaitTime 0
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL vectorAdd_system
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file vectorAdd.v SYSTEM_VERILOG PATH vectorAdd.v TOP_LEVEL_FILE
add_fileset_file vectorAdd_system.v SYSTEM_VERILOG PATH vectorAdd_system.v TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL vectorAdd_system
add_fileset_file vectorAdd.v SYSTEM_VERILOG PATH vectorAdd.v TOP_LEVEL_FILE
add_fileset_file vectorAdd_system.v SYSTEM_VERILOG PATH vectorAdd_system.v TOP_LEVEL_FILE
add_fileset_file acl_data_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_data_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_debug_mem.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_debug_mem.v TOP_LEVEL_FILE
